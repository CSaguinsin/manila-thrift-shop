...
import OtherComponent from "./CheckoutComponents/OtherComponent";



const Checkout1 = () => {
    const countries = ["Parañaque", "Dasmariñas", "Las Piñas", "Manila", "Pasay", "Makati"];
    ...
    const handlePayButtonClick = () => {
        setShowMessage((prevShowMessage) => !prevShowMessage); // Toggle the showMessage state
    };
                    ...
                    <div className="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
                        ...
                        <div className="p-8 bg-gray-100 flex flex-col lg:w-full xl:w-3/5">
                            <button className="border border-transparent hover:border-gray-300 bg-gray-900 hover:bg-white text-white hover:text-gray-900 flex flex-row justify-center items-center space-x-2 py-4 rounded w-full">
                                ...
                                <div>
                                    <p className="text-base leading-4">Apple Pay</p>
                                </div>
                            </button>
                            ...
                            <label className="mt-8 text-base leading-4 text-gray-800">City</label>
                            <div className="mt-2 flex-col">
                            ...
                            <button
                                ...
                                onClick={handlePayButtonClick} // Add the onClick handler to the button
                                >
                                <div>
                                ...
                                <div className="bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3" role="alert">
                                    ...
                                    <p className="text-sm">Thank you for ordering in Manila Thrift Shop.</p>
                                </div>
                                )}
                            </div>
                            </div>
